		                    ...
		                    <?php foreach($rows as $row): ?>
			                    <div class="row">
			                        <div class="col-12 col-sm-12 col-md-2 text-center">
			                                <img class="img-responsive" src="https://localhost/netbeans/eShop/images/<?php echo htmlentities($row['product_id'], ENT_QUOTES, 'UTF-8'); ?>/img0.png" alt="prewiew" width="120" height="80">
			                        </div>
